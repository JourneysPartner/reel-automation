...
【VOICEVOX 読み間違い対策（厳守）】
音声合成（VOICEVOX）が誤読しやすい形を避け、台本では以下のように書くこと。
- 「人」を「ひと」と読ませたい場面では、漢字「人」ではなく ひらがなで「ひと」と書く
  例: × 「経費にしてる人いない？」 → ○ 「経費にしてるひといない？」
  ※「3人」「外国人」のように「ジン/ニン」と読む場面は漢字のままでよい
- 数字+助数詞で「ひと/ふた/み」と読ませたい場面は、数字ではなくひらがなで書く
  例: × 「1部屋」を『ひとへや』と読ませたい → ○ 「ひと部屋」と書く
  ※「6部屋」など2以上で漢字読み（ロク/サン）でよい場面は数字のままでOK
- 「〜費はね、」「〜代はね、」のように 名詞+「はね」 で終わる形は使わない
  （VOICEVOX が「はね」を動詞「跳ね」と誤認識して『ハネ』と読むため）
  例: × 「光熱費はね、〜」 → ○ 「光熱費は、〜」「光熱費なんだけどね、〜」「光熱費って、〜」
